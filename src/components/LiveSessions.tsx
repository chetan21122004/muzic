            ...
            <div key={i} className="group cursor-pointer">
              <div className="p-[3px] rounded-2xl" style={{ background: "linear-gradient(135deg, hsl(358,93%,47%), hsl(358,93%,30%), hsl(358,93%,47%))" }}>
                <div className="relative rounded-[14px] overflow-hidden aspect-[3/4] bg-secondary">
                  <img src={s.img} alt={s.name} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" onError={(e) => { (e.target as HTMLImageElement).src = "/homepage_banners/banner_1.png"; }} />
