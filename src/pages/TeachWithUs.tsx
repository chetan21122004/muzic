    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-[#f7f7f9] py-16 border-b border-gray-100">
        <div className="container mx-auto px-4 text-center">
          ...
          <a
            href="#apply"
            className="inline-flex items-center gap-2 bg-primary text-white font-bold px-8 py-3.5 rounded-full hover:bg-primary/90 transition-colors mt-6 shadow-lg shadow-primary/20"
          >
            Apply Now →
          </a>
        </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-extrabold text-gray-900">Why Teach at Muziclub?</h2>
            <p className="text-gray-400 text-sm mt-2">We give our teachers everything they need to thrive</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {benefits.map((b, i) => (
              <div
                key={i}
                className="bg-[#f7f7f9] rounded-2xl p-6 border border-gray-100 hover:shadow-md hover:-translate-y-0.5 transition-all duration-200"
              >
      ...
      {/* Application Form */}
      <section id="apply" className="bg-[#f7f7f9] py-16 border-y border-gray-100">
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto">
            <div className="text-center mb-10">
              <h2 className="text-3xl font-extrabold text-gray-900">Apply to Teach</h2>
              <p className="text-gray-400 text-sm mt-2">Fill in your details below — our team will reach out within 24 hours</p>
            </div>
            ...
            {submitted ? (
              <div className="bg-white rounded-3xl p-10 text-center border border-gray-100 shadow-sm">
                ...
                <p className="text-gray-400 text-sm">Thank you for your interest in teaching at Muziclub. Our team will be in touch very soon.</p>
                <button
